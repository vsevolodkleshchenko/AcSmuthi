...
def transform_cylindrical(m, n, rho, phi, z, k, k_parallel=k_contour_old()):
...
def transform_cartesian(m, n, x, y, z, k, k_parallel=k_contour_old()):
    rho, phi, z = dec_to_cyl(x, y, z)
    return transform_cylindrical(m, n, rho, phi, z, k, k_parallel=k_parallel)


def wvf_transform_cartesian(m, n, xx, yy, zz, k, k_parallel=k_contour_old()):
    wvf_values = []
...
def wvf_transform_cylindrical(m, n, rr, pp, zz, k, k_parallel=k_contour_old()):
    wvf_values = []
